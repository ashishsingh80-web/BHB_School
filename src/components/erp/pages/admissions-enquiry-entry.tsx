import { createEnquiry } from "@/app/(erp)/actions/admissions";
...
export async function AdmissionsEnquiryEntryPage() {
    ...
    <div className="max-w-2xl space-y-6">
      {!session ? (
        <p className="text-muted-foreground text-sm">
          Create an academic session under Master Setup before recording enquiries.
        </p>
      ) : (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Capture lead details. Follow-ups and conversion live in the enquiry list
              and tracker.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form action={createEnquiry} className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <textarea
                  ...
                  placeholder="Conversation summary, requirements…"
                />
              </div>
